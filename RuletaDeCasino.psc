...
Funcion idUser <- pedirDatosInicioSesion (usuarioDNI, usuarioContrasenia, datosDeVuelta)
...
Funcion opMenu <- MostrarSegundoMenu ( opMenu, usuarioNombre, i )
	Definir opcionMenu Como Caracter
	Borrar Pantalla
	Escribir "*******************************************"
	Escribir "*                  MENU                   *"
...
Funcion CargarNumerosRuleta (ruleta, totalPosiciones, i)
...
Funcion posicionCaer <- MostrarRuleta(ruleta, totalPosiciones, i, j, posicionInicial, vueltas, posicionCaer, velocidadPelotita)
	//************************************ Mostrar ruleta ************************************
	...
	// Definir la cantidad de vueltas completas (al menos 1)
    vueltas <- 3 + Azar(5)
...
Funcion MostrarReglas(mensaje)
    ...
    Repetir
        ...
        Escribir "*   5 -> Consejos para jugar responsablemente *"
        Escribir "*   6 -> Salir                            *"
        Escribir "*******************************************"
        Leer mensaje
...
Funcion apuestaEntero <- usuarioApuestaFicha(plataJugadaE)
	...
	Mientras pudeSeguir = 1 o (apuestaEntero < 0 y apuestaEntero > 13) Hacer
...
Funcion UsuarioGanoPerdio(plataJugadaE, apuestaEntero, posicionCaer, idUser, usuarioPlata , usuarioNombre, numerosRojos, numerosNegros, columna1, columna2, columna3)
	Escribir ""
	Escribir "*******************************************"
	...
	Segun apuestaEntero Hacer
		...
		caso 13:
			...
			Si (posicionCaer = numJugado) Entonces
...
Algoritmo Ludopatía
    ...
    Definir cont, j ,posicionInicial, totalPosiciones, vueltas, posicionCaer, opMenu, DNI, bienMal, idUser, pudeSeguir, plataJugadaE, apuestaEntero, opSiNo, aux, ErrorSesion Como Entero
	Definir intervalo , velocidadPelotita como Real
	Definir nombre, apellido, contrasenia, opcionSiNo, plataJugadaC, esperandoUsuario Como Caracter
	cont <- 0
	totalPosiciones <- 37
	velocidadPelotita <- 1
	ErrorSesion <- 1
	...
	Repetir
		...
		SiNo
			...
			Si opMenu = 2 Entonces
				Repetir
					idUser <- pedirDatosInicioSesion(usuarioDNI, usuarioContrasenia, datosDeVuelta)
		...
		Si (ErrorSesion <> 1) Entonces
			...
			Repetir
				...
				Esperar 2 Segundos
				opMenu <- MostrarSegundoMenu(opMenu, usuarioNombre, i )
					...
					caso 2:
						...
						Repetir
							Si opcionSiNo = "SI" Entonces
								...
								CargarNumerosRuleta(ruleta, totalPosiciones, i)
								Esperar 1 Segundos
								// Funcion que muestra la ruleta en posicion del tablero
								posicionCaer <- MostrarRuleta(ruleta, totalPosiciones, i, j, posicionInicial, vueltas, posicionCaer, velocidadPelotita)
								Escribir ""
								Escribir "*******************************************"
							...
							sino
								...
								SiNo
									...
									Esperar 1 Segundos
									apuestaEntero <- usuarioApuestaFicha(plataJugadaE)
									...
									UsuarioGanoPerdio(plataJugadaE, apuestaEntero, posicionCaer, idUser, usuarioPlata , usuarioNombre, numerosRojos, numerosNegros, columna1, columna2, columna3)
